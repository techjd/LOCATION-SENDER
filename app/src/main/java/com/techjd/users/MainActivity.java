    ...
    public void getLocation()
    {
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            if (mLastLocation != null) {
                ...
                double _latitude = mLastLocation.getLatitude();
                double _longitude = mLastLocation.getLongitude();
//                Toast.makeText(MainActivity.this, "Latitude " + String.valueOf(mLastLocation.getLatitude()),Toast.LENGTH_LONG).show();
//                Toast.makeText(MainActivity.this, "Longitude: " + String.valueOf(mLastLocation.getLongitude()),Toast.LENGTH_LONG ).show();

                DatabaseReference currentUserDb = FirebaseDatabase.getInstance().getReference().child("Users").child(userId);
                Map<String, Object> userInfo = new HashMap<String, Object>();
                userInfo.put("latitude", _latitude);
                userInfo.put("longitude", _longitude);
...
//        Toast.makeText(MainActivity.this, "Longitude: " + String.valueOf(mLastLocation.getLongitude()),Toast.LENGTH_LONG ).show();
        ...
        double _longitude = mLastLocation.getLongitude();
        String longit = Double.toString(_longitude);
        mAuth = FirebaseAuth.getInstance();
        String userId = mAuth.getCurrentUser().getUid();
